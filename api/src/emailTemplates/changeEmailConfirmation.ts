...
const getChangeEmailConfirmation = (origin: string, token: string): string => {
  return `
    <div style="height: 100%; width: 100%; background-color: #2B2D31;">
      <div style="padding: 100px 0; text-align: center;">
        ...
        <a href="${origin}${API_PATHS.AUTH.CONFIRM_CHANGE_EMAIL.dir}?token=${token}" style="text-decoration: none; color: #ffffff;">
